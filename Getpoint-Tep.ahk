...
Gui, Add, Edit, w320 r2 vCtrl_SBText_Label
...
Do_something:
    ;msgbox, hi
    PointName := Clipboard
    tempData = % chr(34) msX chr(44) msY chr(34) " " chr(59) " windows =" mrX "," mrY " , Client = " mcX "," mcY " , Color=" mClr ",Title=" t1
    Data_ := % chr(59) . "Global " PointName . " := " . tempData
    FileAppend , %Data_% `n , %A_ScriptDir%\XYrecord.txt, UTF-8
return
...
Update:
    ...
    ;Data Label
    FileRead, ListLabel, PTP_Label.txt
    UpdateText("Ctrl_SBText_Label", ListLabel)
